...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=1456008310ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Tables récentes" class="drop_button btn">Récentes</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=martita&table=user">`martita`.`user`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=martita&table=product">`martita`.`product`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=martita&table=doctrine_migration_versions">`martita`.`doctrine_migration_versions`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=martita&table=category">`martita`.`category`</a></li></ul></div><div class="drop_list"><button title="Tables préférées" class="drop_button btn">Préférées</button><ul id="pma_favorite_list"><li class="warp_link">Pas de tables préférées.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="222f5b257070693f5f3e2f2930664d41">
    ...
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Faire Entrée pour exécuter la requête                    </span>
                            ...
                            targetdb="martita" targettable="category">
            ...
            Daté du
                            ...
                            <span class="query">SELECT * FROM `category`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="martita" targettable="doctrine_migration_versions">
                            <div class="action_content">
                    <span class="action collapse">
            Réduire
                    </span>
            ...
            Daté du
                            ...
                            <span class="query">SELECT * FROM `doctrine_migration_versions`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="martita" targettable="product">
                            <div class="action_content">
                    <span class="action collapse">
            Réduire
                    </span>
            ...
            Daté du
                            ...
                            <span class="query">SELECT * FROM `product`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="martita" targettable="user">
                            <div class="action_content">
                    <span class="action collapse">
            Réduire
                    </span>
