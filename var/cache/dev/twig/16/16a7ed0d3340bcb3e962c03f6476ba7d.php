...
class __TwigTemplate_832f6643745003b5735e108e81ce802c extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    <div class=\"row\">
        ...
        echo "</h1>
            <p>";
        // line 17
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["product"]) || array_key_exists("product", $context) ? $context["product"] : (function () { throw new RuntimeError('Variable "product" does not exist.', 17, $this->source); })()), "subtitle", [], "any", false, false, false, 17), "html", null, true);
        echo "</p>
            <span class=\"product-page-price\">";
        // line 18
        echo twig_escape_filter($this->env, twig_number_format_filter($this->env, (twig_get_attribute($this->env, $this->source, (isset($context["product"]) || array_key_exists("product", $context) ? $context["product"] : (function () { throw new RuntimeError('Variable "product" does not exist.', 18, $this->source); })()), "price", [], "any", false, false, false, 18) / 100), 2, ",", "."), "html", null, true);
        echo "€</span>
            <hr>
            <p>";
        // line 20
...
";
    ...
    {
        return array (  148 => 26,  141 => 21,  137 => 20,  132 => 18,  128 => 17,  124 => 16,  116 => 13,  111 => 10,  101 => 9,  90 => 6,  80 => 5,  60 => 3,  37 => 1,);
    }
...
", "product/show.html.twig", "C:\\xampp\\htdocs\\mcmc\\templates\\product\\show.html.twig");
    }
}
