...
class __TwigTemplate_b16f1ff118416506534eebd677ab3652 extends Template
{
    private $source;
    private $macros = [];
...
{% block content %}
    ...
    <div class=\"row mt-5\">
        <div class=\"col-md-4\">
            <img src=\"/assets/images/{{ product.illustration }}\" alt=\"{{ product.name }}\" class=\"img-fluid\">
        </div>
        <div class=\"col-md-8\">
            <h1>{{ product.name }}</h1>
...
", "product/show.html.twig", "C:\\xampp\\htdocs\\symfony\\mcmc\\templates\\product\\show.html.twig");
    }
}
