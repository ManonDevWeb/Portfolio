...
class __TwigTemplate_817fcfd54d1e1a912b713e8f6844d802 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_content($context, array $blocks = [])
    {
        ...
        // line 6
        echo "    <h1 class = \"top-title-cart\">Mon panier</h1>
    ...
    ";
        ...
        <div class=\"text-center mb-5\">
            ...
            echo "\" class=\"btn btn-mcmc btn-cart mt-3\">Valider mon panier</a>
        </div>
        ";
        } else {
            // line 63
    ...
    {
        return array (  213 => 63,  207 => 60,  203 => 59,  199 => 58,  193 => 54,  186 => 52,  184 => 51,  177 => 47,  173 => 46,  168 => 44,  164 => 43,  157 => 39,  153 => 38,  149 => 37,  144 => 35,  140 => 34,  134 => 31,  130 => 30,  122 => 27,  118 => 25,  113 => 24,  111 => 23,  96 => 10,  93 => 9,  89 => 6,  79 => 5,  59 => 3,  36 => 1,);
    }
...
{% block content %}
    <h1 class = \"top-title-cart\">Mon panier</h1>
    ...
    {% if cart|length > 0 %}
        ...
        <table class=\"table mt-3\">
            ...
            <tbody>
                ...
                {% for prod in cart %}
                    <tr>
                        <th>
                            <img src=\"/assets/images/{{ prod.product.illustration }}\" height=\"75px\" alt=\"{{ prod.product.name }}\">
                        </th>
                        <td>
                            <span class =\"font-weight-bold\">{{ prod.product.name }}</span><br>
        ...
        <div class=\"text-center mb-5\">
            ...
            <a href=\"{{ path('app_order') }}\" class=\"btn btn-mcmc btn-cart mt-3\">Valider mon panier</a>
        </div>
        {% else %}
            <hr>
            <p><b>Votre panier est vide.</b></p>
