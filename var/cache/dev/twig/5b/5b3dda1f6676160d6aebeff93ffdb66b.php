...
class __TwigTemplate_911d7f01731faa9e65e89630d1f9948c extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_content($context, array $blocks = [])
    {
        ...
        // line 9
        echo "    <h2 class=\"mt-5\">Confirmation de commande</h2>
    <br>
    <p>
        Bonjour <strong>";
        // line 12
        ...
        ";
        // line 17
        echo twig_get_attribute($this->env, $this->source, (isset($context["order"]) || array_key_exists("order", $context) ? $context["order"] : (function () { throw new RuntimeError('Variable "order" does not exist.', 17, $this->source); })()), "delivery", [], "any", false, false, false, 17);
        echo "
        <hr>
    ...
    {
        return array (  137 => 19,  132 => 17,  128 => 16,  123 => 14,  119 => 13,  113 => 12,  108 => 9,  98 => 8,  80 => 5,  60 => 3,  37 => 1,);
    }
...
{% block title %}{{parent()}}Confirmation de commande{% endblock %}

{% block carousel %}
{% endblock %}

{% block content %}
    <h2 class=\"mt-5\">Confirmation de commande</h2>
    <br>
    <p>
    ...
    {# {{ dump(order) }} #}
{% endblock %}
", "order_validate/index.html.twig", "C:\\xampp\\htdocs\\mcmc\\templates\\order_validate\\index.html.twig");
    }
}
